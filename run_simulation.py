...
def run_simulation():
    ...
    # Find best iterations for classifiers
    print("Finding the best number of iterations...")
    best_n_iter_results = {name: find_best_n_iter(X_selected, rkf, y) for name, X_selected in selected_features.items()}
    print("Best number of iterations:", best_n_iter_results)
    ...
    for name, clf in classifiers.items():
        ...
        explain_model_shap(clf, X_selected)
